...
# import datetime module to help format time values for certain metadata attribute types
from datetime import datetime
# import getpwuid from pwd to help identify owners of files
...
# ----------------------------------------------------------------
# Extracst file metadata using hachoir module
# @param path - filename path passed in from command line argument
